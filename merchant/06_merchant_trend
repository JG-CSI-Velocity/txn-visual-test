# ===========================================================================
# MERCHANT TREND: Top 10 Merchant Shares Over Time (Conference Edition)
# ===========================================================================
# Multi-line: monthly share for top 10 merchants. (14,7).

fig, ax = plt.subplots(figsize=(14, 7))

trend_colors = BRACKET_PALETTE[:8] + [GEN_COLORS['muted'], GEN_COLORS['warning']]

for i, merchant in enumerate(top10_merchants):
    m_data = merch_monthly[merch_monthly['merchant_consolidated'] == merchant].sort_values('year_month')
    if len(m_data) == 0:
        continue
...
ax.set_title("Top 10 Merchant Trends",
             fontsize=26, fontweight='bold',
             color=GEN_COLORS['dark_text'], pad=35, loc='left')
ax.text(0.0, 1.02, "Are merchant market shares stable or shifting?",
