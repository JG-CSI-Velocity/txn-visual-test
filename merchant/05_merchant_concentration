# ===========================================================================
# MERCHANT CONCENTRATION: Cumulative Curve (Conference Edition)
# ===========================================================================
# How many merchants cover 80% of transactions? (14,7).

fig, ax = plt.subplots(figsize=(14, 7))

plot_data = merch_top50.copy()
...
ax.set_title("Merchant Concentration Curve",
             fontsize=26, fontweight='bold',
             color=GEN_COLORS['dark_text'], pad=35, loc='left')
ax.text(0.0, 1.02, "How many merchants does it take to cover 80% of card activity?",
